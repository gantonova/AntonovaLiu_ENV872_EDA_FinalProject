...
Visitation_by_year_ts <- ts(Visitation_by_month_gathered$Recreational_Visits, start = c(1999,1), frequency=6)

#is 12 right

Visitation_by_year_Decomposed <- stl(Visitation_by_year_ts, s.window="periodic")

plot(Visitation_by_year_Decomposed)
